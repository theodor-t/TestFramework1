...
public class EmployeePositions extends BasePage {
    public EmployeePositions(WebDriver driver) {
        super(driver);
    }
    ...
    public EmployeePositions checkIfExistElements() {
        //Boolean
        ...
        if (createBtnPresence == true && headingTextPresence == true && dataTablePresence == true) {
            System.out.println("EmployeePositions is OK");

        } else {
            System.out.println("EmployeePositions is FAIL");
        }
        return this;
    }
}
