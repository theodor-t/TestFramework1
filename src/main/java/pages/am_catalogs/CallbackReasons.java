...
public class CallbackReasons extends BasePage {
    public CallbackReasons(WebDriver driver) {
        super(driver);
    }
    ...
    public CallbackReasons checkIfExistElements() {
        //Boolean
        ...
        if (createBtnPresence == true && headingTextPresence == true && dataTablePresence == true) {
            System.out.println("CallbackReasons is OK");

        } else {
            System.out.println("CallbackReasons is FAIL");
        }
        return this;
    }
}
